  ...
  <div class="dept-manage">
    <div class="query-form">
      <el-form  ref="queryForm" :model="queryForm" :inline="true">
        ...
        <el-form-item>
          <el-button @click="getDeptList" type="primary" v-has="'dept-query'">查询</el-button>
      ...
      >
        ...
        <el-table-column label="操作">
          <template #default="scope">
            <el-button size="mini" type="primary" @click="handleEdit(scope.row)" v-has="'dept-edit'">编辑</el-button>
            <el-button
              size="mini"
              type="danger"
...
export default {
  ...
  methods: {
    ...
    async handleDel(_id) {
      this.action = "delete"
      await this.$api.operateDept({ _id, action: this.action })
    ...
    handleSubmit() {
      this.$refs.dialogForm.validate(async (valid) => {
        if (valid) {
          ...
          delete params.user
          await this.$api.operateDept(params)
